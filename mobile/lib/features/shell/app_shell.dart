...
class _AppShellState extends State<AppShell> {
  ...
  void _openStudy(BuildContext context, StudySession study) {
    Navigator.of(context).push(
      MaterialPageRoute<void>(builder: (_) => VerseStudyScreen(study: study)),
    );
  }
    ...
    return ListView(
      ...
      children: [
        const Row(
          children: [
            Expanded(
              child: _MetricTile(label: 'Verses reviewed', value: '112'),
            ),
            SizedBox(width: 12),
            Expanded(
              child: _MetricTile(label: 'Current streak', value: '6 days'),
            ),
          ],
        ),
        const SizedBox(height: 12),
        const Row(
          children: [
            Expanded(
              child: _MetricTile(label: 'Packages active', value: '3'),
            ),
            SizedBox(width: 12),
            Expanded(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.bodyLarge?.copyWith(color: const Color(0xFFE6ECF7)),
          ),
          const SizedBox(height: 18),
          FilledButton.tonal(
...
const demoPackages = [
  ContentPackage(
    ...
    summary:
        'A downloaded package ready for offline verse review, section drills, and chapter study creation.',
    sections: [
      'El Espíritu Santo prometido',
      'Pentecostés',
      'Pedro sana a un cojo',
    ],
  ),
  ContentPackage(
    id: 'bq-acts-1-9',
    ...
    summary:
        'An English season package in the store with free download access and section-based study entry points.',
    sections: [
  ...
  ContentPackage(
    ...
    summary:
        'A teaser card for later paid audio flows. The shell keeps the account prompt contextual instead of forcing sign-in up front.',
